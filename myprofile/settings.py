...
SECRET_KEY = 'django-insecure-+_yo$q_f&cg_5o7=+rtwy&iis8md5qroy179sy!9y$qe*q9con'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            # You can add additional paths if needed
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'profilee/static'),
]
